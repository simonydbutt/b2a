...
def test_pullCandles():
    ...
    endTime = 1516406400
    df = B.pullCandles(
        "ETHBTC", "1d", startTime=1514764800, endTime=1516406400, isDemo=True
    )
...
def test_list2Dict():
    ...
    dictData = {
        "milliTimestamp": 1514764800000,
        "open": "0.05358600",
        "high": "0.05720000",
        "low": "0.05340100",
        "close": "0.05636700",
        "volume": "312440.75700000",
        "quoteVol": "17404.15888156",
        "numTrades": 406017,
        "takerBaseAssetVol": "150566.08800000",
        "takerQuoteAssetVol": "8389.50328492",
        "TS": 1514764800.0,
    }
