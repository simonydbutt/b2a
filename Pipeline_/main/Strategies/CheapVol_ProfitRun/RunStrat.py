...
from Pipeline_.main.Strategies.CheapVol_ProfitRun.IsProfitRun import IsProfitRun
from Pipeline_.main.PullData.PullBinance import PullBinance
from Pipeline_.main.Finance.HistoricalKellyPS import HistoricalKellyPS
...
class RunStrat:
    ...
    def __init__(self, stratName=None, gran='1d', base='BTC', assetList='all',
                 ...
                 dbPath='Pipeline_/DB', baseStratName='CheapVol_ProfitRun'):
